...
mod serde_json_benches {
    use super::*;

    #[divan::bench]
    fn serialize(bencher: divan::Bencher) {
    ...
    #[divan::bench]
    fn deserialize(bencher: divan::Bencher) {
        let data = TestData::sample();
    ...
    #[divan::bench]
    fn roundtrip_ser_de(bencher: divan::Bencher) {
        let data = TestData::sample();
